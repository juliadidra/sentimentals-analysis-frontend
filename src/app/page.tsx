...
const App = () => {
  return (
    <main className="flex-1 dark:bg-zinc-950 transition-all flex flex-col gap-5 items-center justify-center">
      ...
      <p className="w-96 text-center text-sm text-zinc-500 dark:text-zinc-400 font-medium">Enter a YouTube video link and we'll send it to our AI system for analysis.</p>
      <Form/>
    </main>
  );
};
